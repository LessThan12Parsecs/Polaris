        ...
        public void Update()
        {
            ...
            foreach (var image in m_TempAugmentedImages)
            {
                ...
                if (image.TrackingState == TrackingState.Tracking && visualizer == null)
                {
                    ...
                    // GameObject video = Instantiate(VideoPrefab, image.CenterPose.position, Quaternion.identity);
                    // GameObject arrow = Instantiate(TestArrowPrefab, anchor.transform.position + new Vector3(0.3f, 0f, 0f), Quaternion.identity);    
                    visualizer.Image = image;
                    visualizer.CouchObject = couchObject;
                    visualizer.PrinterObject = printerObject;
                    visualizer.ExitObject = exitObject;
                    visualizer.PhoneObject = phoneObject;
                    visualizer.arrowObject = arrow;
                    visualizer.userObject = userObject;
